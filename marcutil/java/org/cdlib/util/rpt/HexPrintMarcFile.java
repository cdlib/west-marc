...
/**
 * Hex print a file marc format file. This class will print record number
 * and offsets for marc records, in addition to the hex data. The hex formatting
 * is three lines hex under character.
 *
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: HexPrintMarcFile.java,v 1.3 2002/07/16 22:07:24 smcgovrn Exp $
 */

public class HexPrintMarcFile
{
    private static Logger log = Logger.getLogger(HexPrintMarcFile.class);
    ...
    public static void main(String[] args)
    {
        ...
        HexPrintMarcFile hp = new HexPrintMarcFile();
