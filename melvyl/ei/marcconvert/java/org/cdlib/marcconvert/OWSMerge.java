...
public class OWSMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	private static Logger log = Logger.getLogger(OWSMerge.class);
	 ...
	 */
	public OWSMerge() throws MarcParmException {
	}
	...
	private Properties processConfiguration() {
		...
		String test = null;
		System.setProperty("config", "C:/PAPR/config/OWSMerge.txt");
	...
	private int marcToDir(MarcRecord marcIn) throws Exception {
		try {
			...
			String id901 = marcIn.getFirstValue("901", "a");
			if (id901 != null) id = id901;
	...
	private Status buildCombinedRecord(File dir, Vector arr, MarcRecord outMarc) {
		 MarcRecord marcRec = null;
	       ...
	       for (int i=0; i < arr.size(); i++) {
	            ...
	            id901 = marcRec.getFirstValue("901", "a");
	...
	private void appendHoldMarc(MarcRecord outMarc, MarcRecord inMarc) {
		inMarc.allFields("895");
		inMarc.deleteFields("008");
		appendAll(outMarc, inMarc);
	}
