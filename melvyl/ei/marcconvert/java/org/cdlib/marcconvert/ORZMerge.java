...
public class ORZMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	private static Logger log = Logger.getLogger(ORZMerge.class);
	 ...
	 */
	public ORZMerge() throws MarcParmException {
	}
	...
	private int marcToDir(MarcRecord marcIn) throws Exception {
		try {
			String id = marcIn.getFirstValue("907", "a");
