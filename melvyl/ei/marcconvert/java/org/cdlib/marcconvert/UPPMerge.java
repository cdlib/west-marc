...
public class UPPMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	private static Logger log = Logger.getLogger(UPPMerge.class);
	 ...
	 */
	public UPPMerge() throws MarcParmException {
	}
	...
	private Properties processConfiguration() {
		...
		String test = null;
		System.setProperty("config", "C:/PAPR/config/UPPMerge.txt");
	...
	private int marcToDir(MarcRecord marcIn) throws Exception {
		try {
			String id = marcIn.getFirstValue("997", "a");
			if(id != null)
	...
	private Status buildCombinedRecord(File dir, Vector arr, MarcRecord outMarc) {
		 MarcRecord marcRec = null;
	       ...
	       for (int i=0; i < arr.size(); i++) {
	            ...
	            id901 = marcRec.getFirstValue("853", "a");
