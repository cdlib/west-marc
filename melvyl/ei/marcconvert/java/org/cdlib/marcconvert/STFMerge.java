...
public class STFMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	public STFMerge() throws MarcParmException {
	}
	...
	private Properties processConfiguration() {
		...
		String test = null;
		System.setProperty("config", "C:/PAPR/config/HIN.txt");
