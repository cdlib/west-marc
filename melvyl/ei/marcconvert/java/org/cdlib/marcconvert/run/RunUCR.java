...
import org.cdlib.marcconvert.UCRConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;


/**
 * This class performs conversion of marc records from the UCR source
 * by passing a UCRConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto:rmoon@library.berkeley.edu">Ralph Moon</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCR.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $
 */
public class RunUCR
{
	/**
	 ...
	 */
    private static Logger log = Logger.getLogger(RunUCR.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCR.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunUCR_" + startDate.getTime());

            log.info("UCR conversion started");

            UCRConvert ucr = new UCRConvert();

            // Get a new RunConvert using our conversion class.
            RunConvert run = new RunConvert(ucr);

            // RunConvert.process handles all I/O and the calling
            // of the MarcConvert routines to perform the conversion.
            int rc = run.convert();
            log.info("UCR conversion completed - return code = " + rc);
