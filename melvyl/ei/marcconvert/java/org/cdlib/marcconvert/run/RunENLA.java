...
import org.cdlib.marcconvert.ENLAConvert;
 ...
 * @version $Id: RunENLA.java,v 1.1 2004/05/21 00:18:19 mreyes Exp $
 */
public class RunENLA
{
	/**
	 * log4j Logger for this class.
	 */
    private static Logger log = Logger.getLogger(RunENLA.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunENLA.java,v 1.1 2004/05/21 00:18:19 mreyes Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunENLA_" + startDate.getTime());

            log.info("ENLA conversion started");

            ENLAConvert ucla = new ENLAConvert();
            ...
            int rc = run.convert();
            log.info("ENLA conversion completed - return code = " + rc);
