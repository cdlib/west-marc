...
import org.cdlib.marcconvert.LCNConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;


/**
 * This class performs conversion of marc records from the LCN source
 * by passing a LCNConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto: karen.coyle@ucop.edu">Karen Coyle</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunLCN.java,v 1.6 2002/11/12 21:41:09 smcgovrn Exp $
 */
public class RunLCN
{
	/**
	 ...
	 */
    private static Logger log = Logger.getLogger(RunLCN.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunLCN.java,v 1.6 2002/11/12 21:41:09 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunLCN_" + startDate.getTime());

            log.info("LCN conversion started");

            LCNConvert lcnames = new LCNConvert();

            // Get a new RunConvert using our conversion class.
            RunConvert run = new RunConvert(lcnames);

            // RunConvert.process handles all I/O and the calling
            // of the MarcConvert routines to perform the conversion.
            int rc = run.convert();
            log.info("LCN conversion completed - return code = " + rc);
