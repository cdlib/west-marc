 ...
 */
public class RunOKUMerge
{
	/**
	 * log4j Logger for this class.
	 */
    static Logger log = Logger.getLogger(RunOKUMerge.class);
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunOKUMerge" + startDate.getTime());
