...
import org.cdlib.marcconvert.GTUConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;


/**
 * This class performs conversion of marc records from the GTU source
 * by passing a GTUConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto:gmills@library.berkeley.edu">Garey Mills</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunGTU.java,v 1.6 2002/11/12 21:41:09 smcgovrn Exp $
 */
public class RunGTU
{
	/**
	 ...
	 */
    private static Logger log = Logger.getLogger(RunGTU.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunGTU.java,v 1.6 2002/11/12 21:41:09 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunGTU_" + startDate.getTime());

            log.info("GTU conversion started");

            GTUConvert cvt = new GTUConvert();
            ...
            int rc = run.convert();
            log.info("GTU conversion completed - return code = " + rc);
