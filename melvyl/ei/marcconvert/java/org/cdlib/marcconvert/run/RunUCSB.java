...
import org.cdlib.marcconvert.UCSBConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;


/**
 * This class performs conversion of marc records from the UCSB source
 * by passing a UCSBConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto: karen.coyle@ucop.edu">Karen Coyle</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCSB.java,v 1.3 2002/11/12 21:41:10 smcgovrn Exp $
 */
public class RunUCSB
{
	/**
	 * log4j Logger for this class.
	 */
    private static Logger log = Logger.getLogger(RunUCSB.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCSB.java,v 1.3 2002/11/12 21:41:10 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunUCSB_" + startDate.getTime());

            log.info("UCSB conversion started");

            UCSBConvert sb = new UCSBConvert();

            // Get a new RunConvert using our conversion class.
            RunConvert run = new RunConvert(sb);

            // RunConvert.process handles all I/O and the calling
            // of the MarcConvert routines to perform the conversion.
            int rc = run.convert();
            log.info("UCSB conversion completed - return code = " + rc);
