 ...
 * instantiating a RL21Convert object as a UCBL type conversion, then
 * passing that RL21Convert object to a new RunConvert object and invoking
 * RunConvert.convert() method.
 *
 * This class performs Marc Conversion by calling RL21Convert.
 *
 *
 * @author <a href="mailto:rmoon@library.berkeley.edu">Ralph Moon</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCBL21.java,v 1.1 2005/04/05 17:01:42 rkl Exp $
 */
public class  RunUCBL21
{
	/**
	 * log4j Logger for this class.
	 */
    private static Logger log = Logger.getLogger(RunUCBL21.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCBL21.java,v 1.1 2005/04/05 17:01:42 rkl Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            RL21Convert boalt = new RL21Convert(RL21Convert.BOALT);
