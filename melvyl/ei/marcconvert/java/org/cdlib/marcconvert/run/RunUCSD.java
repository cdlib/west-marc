...
/**
 * This class performs conversion of marc records from the UCSD source
 * by passing a UCSDConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto:gmills@library.berkeley.edu">Garey Mills</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCSD.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $
 */
public class RunUCSD
{
	/**
	 * log4j Logger for this class.
	 */
    private static Logger log = Logger.getLogger(RunUCSD.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCSD.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            UCSDConvert cvt = new UCSDConvert();
            ...
            int rc = run.convert();
            log.info("UCSD conversion completed - return code = " + rc);
