...
import org.cdlib.marcconvert.NullConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;


/**
 * This class performs a null conversion of marc records from any source
 * by passing a NullConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto: karen.coyle@ucop.edu">Karen Coyle</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunNull.java,v 1.6 2002/11/12 21:41:09 smcgovrn Exp $
 */
public class RunNull
{
	 ...
	 */
    private static Logger log = Logger.getLogger(RunNull.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunNull.java,v 1.6 2002/11/12 21:41:09 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunNull_" + startDate.getTime());

            log.info("Null conversion started");

            NullConvert nullc = new NullConvert();

            // Get a new RunConvert using our conversion class.
            RunConvert run = new RunConvert(nullc);

            // RunConvert.process handles all I/O and the calling
            // of the MarcConvert routines to perform the conversion.
            int rc = run.convert();
            log.info("Null conversion completed - return code = " + rc);
