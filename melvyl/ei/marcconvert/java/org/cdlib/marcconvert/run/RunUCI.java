...
import org.cdlib.marcconvert.UCIConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;


/**
 * This class performs conversion of marc records from the UCI source
 * by passing a UCIConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto:rmoon@library.berkeley.edu">Ralph Moon</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCI.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $
 */
public class RunUCI
{
	/**
	 ...
	 */
    private static Logger log = Logger.getLogger(RunUCI.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCI.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunUCI_" + startDate.getTime());

            log.info("UCI conversion started");

            UCIConvert uci = new UCIConvert();

            // Get a new RunConvert using our conversion class.
            RunConvert run = new RunConvert(uci);

            // RunConvert.process handles all I/O and the calling
            // of the MarcConvert routines to perform the conversion.
            int rc = run.convert();
            log.info("UCI conversion completed - return code = " + rc);
