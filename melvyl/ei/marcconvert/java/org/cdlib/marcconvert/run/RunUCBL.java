...
/**
 * This class performs conversion of marc records from the UCBL source
 * instantiating a RLINConvert object as a UCBL type conversion, then
 * passing that RLINConvert object to a new RunConvert object and invoking
 * RunConvert.convert() method.
 *
 * This class performs Marc Conversion by calling RLINConvert.
 *
 *
 * @author <a href="mailto:rmoon@library.berkeley.edu">Ralph Moon</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCBL.java,v 1.5 2002/10/22 22:37:12 smcgovrn Exp $
 */
public class  RunUCBL
{
	/**
	 * log4j Logger for this class.
	 */
    private static Logger log = Logger.getLogger(RunUCBL.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCBL.java,v 1.5 2002/10/22 22:37:12 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunUCBL_" + startDate.getTime());

            log.info("UCBL conversion started");

            RLINConvert boalt = new RLINConvert(RLINConvert.BOALT);

            // Get a new RunConvert using our conversion class.
            RunConvert run = new RunConvert(boalt);

            // RunConvert.process handles all I/O and the calling
            // of the MarcConvert routines to perform the conversion.
            int rc = run.convert();
            log.info("UCBL conversion completed - return code = " + rc);
