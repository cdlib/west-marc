...
import org.cdlib.marcconvert.UCSFConvert;
import org.cdlib.marcconvert.RunConvert;
import org.cdlib.util.marc.MarcParmException;

/**
 * This class performs conversion of marc records from the UCSF source
 * by passing a UCSFConvert converter object to RunConvert and invoking
 * the RunConvert.convert() method.
 *
 * @author <a href="mailto:gmills@library.berkeley.edu">Garey Mills</a>
 * @author <a href="mailto:shawnm@splorkin.com">Shawn McGovern</a>
 * @version $Id: RunUCSF.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $
 */
public class RunUCSF
{
	/**
	 * log4j Logger for this class.
	 */
    private static Logger log = Logger.getLogger(RunUCSF.class);

	/**
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/run/RunUCSF.java,v 1.6 2002/11/12 21:41:10 smcgovrn Exp $";
    ...
    public static void main(String args[])
    {
        try
        {
            ...
            t.setName("RunUCSF_" + startDate.getTime());

            log.info("UCSF conversion started");

            UCSFConvert cvt = new UCSFConvert();
            ...
            int rc = run.convert();
            log.info("UCSF conversion completed - return code = " + rc);
