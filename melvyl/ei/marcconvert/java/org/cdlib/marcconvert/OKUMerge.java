...
public class OKUMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	private static Logger log = Logger.getLogger(OKUMerge.class);
	 ...
	 */
	public OKUMerge() throws MarcParmException {
	}
	...
	private Properties processConfiguration() {
		...
		String test = null;
		System.setProperty("config", "C:/PAPR/config/OKU.txt");
	...
	private Status buildCombinedRecord(File dir, Vector arr, MarcRecord outMarc) {
		...
		for (int i = 0; i < arr.size(); i++) {
			...
			if (!(bibIdLdr.charAt(6) == 'u' || bibIdLdr.charAt(6) == 'v' || bibIdLdr.charAt(6) == 'y'
					|| bibIdLdr.charAt(6) == 'x')) { // base
																					// record
		...
		for (int i = 0; i < arr.size(); i++) {
			...
			if ((holdIdLdr.charAt(6) == 'u' || holdIdLdr.charAt(6) == 'v' || holdIdLdr.charAt(6) == 'y'
					|| holdIdLdr.charAt(6) == 'x')) {
	...
	private void appendBibMarc(MarcRecord outMarc, MarcRecord inMarc) {
		...
		inMarc.deleteFields("852", "899");
		inMarc.deleteFields("945");
