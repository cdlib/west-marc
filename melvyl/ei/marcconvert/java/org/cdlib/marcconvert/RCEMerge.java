...
public class RCEMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	private static Logger log = Logger.getLogger(RCEMerge.class);
	 ...
	 */
	public RCEMerge() throws MarcParmException {
	}
	...
	private Properties processConfiguration() {
		...
		String test = null;
		System.setProperty("config", "C:/PAPR/config/RCEMerge.txt");
	...
	private int marcToDir(MarcRecord marcIn) throws Exception {
		try {
			String id = marcIn.getFirstValue("959", "a");
