...
public class XFFMerge implements ConvertConstants, MarcConstants {
	 ...
	 */
	private static Logger log = Logger.getLogger(XFFMerge.class);
	 ...
	 */
	public XFFMerge() throws MarcParmException {
	}
	...
	private Properties processConfiguration() {
		...
		String test = null;
		System.setProperty("config", "C:/PAPR/config/XFFMerge.txt");
