 ...
 * @version $Id: MarcConvertLHR.java,v 1.1 2010/04/02 19:20:43 aleph16 Exp $
 */
public abstract class MarcConvertLHR
    implements ConvertConstants, MarcConstants
{
	 ...
	 * CVS header string.
	 */
    public static final String cvsHeader = "$Header: /cvs/root/melvyl/ei/marcconvert/java/org/cdlib/marcconvert/MarcConvertLHR.java,v 1.1 2010/04/02 19:20:43 aleph16 Exp $";
     ...
     * {@link #setMarcConvert(Properties, String, ConvertFile) setMarcConvert}
     */
    protected MarcConvertLHR(String inMarc,
                          Properties inConfig,
                          String inDate,
    ...
    public abstract int convertLHR(MarcRecord inRec, MarcRecord outRec, Hashtable outHash, Properties conf);
